...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2016 at 06:35 AM
...
(2, 43, 'Right Shift', 1000, 'admin-login/2/description.txt', 'admin-login/2/input.txt', 'admin-login/2/output.txt', 'admin-login/2/hiddenInput.txt', 'admin-login/2/hiddenOutput.txt', 'admin-login/2/precode.txt', 'admin-login/2/postcode.txt', 2, 10, ''),
(3, 43, 'XOR', 1000, 'admin-login/3/description.txt', 'admin-login/3/input.txt', 'admin-login/3/output.txt', 'admin-login/3/hiddenInput.txt', 'admin-login/3/hiddenOutput.txt', 'admin-login/3/precode.txt', 'admin-login/3/postcode.txt', 2, 10, ''),
(4, 58, 'Add 2', 1000, 'admin-login/4/description.txt', 'admin-login/4/input.txt', 'admin-login/4/output.txt', 'admin-login/4/hiddenInput.txt', 'admin-login/4/hiddenOutput.txt', 'admin-login/4/precode.txt', 'admin-login/4/postcode.txt', 0, 10, '');
...
('13BCE1105', 'Ankit Rai', 2017, 'B.Tech(ElectronicsandCommunicationEngineering)', 'raiankit.kumar2013@vit.ac.in', 'raiankit474@gmail.com', 0, '123', '', ''),
...
(1, 'left shift', '2016-01-01 00:00:00', '2016-01-09 00:00:00', 0, 'begin_key', 1, 0),
...
(43, 'asdfyhbnjk', '2016-06-22 00:00:00', '2016-06-23 00:00:00', 1, 'sid', 0, 0),
...
(57, 'test 1', '2016-01-01 00:00:00', '2016-01-09 00:00:00', 1, '', 1, 0),
(58, 'Test 1', '2016-06-23 00:00:00', '2016-06-24 00:00:00', 1, '', 1, 0);
