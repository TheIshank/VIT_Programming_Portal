...
<link rel="stylesheet" type="text/css" href="Test Schedule/testschedule/jquery.datetimepicker.css"/>
<style type="text/css">
       ...
       function done()
       {
           //if(confirm("Test timings changed"))
            ...
            alert("Test Timings changed");
              ...
              window.open("Test Schedule/testschedule/schedule.php",target='_self');
...
<script src="Test Schedule/testschedule/jquery.js"></script>
<script src="Test Schedule/testschedule/build/jquery.datetimepicker.full.js"></script>
<script>
